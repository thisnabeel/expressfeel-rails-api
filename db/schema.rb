...
ActiveRecord::Schema[7.1].define(version: 2026_03_27_123000) do
  ...
  create_table "layer_item_quiz_answers", force: :cascade do |t|
    t.bigint "layer_quiz_question_id", null: false
    t.text "original", default: "", null: false
    t.text "english", default: "", null: false
    t.integer "position", default: 0, null: false
    t.boolean "correct", default: false, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["layer_quiz_question_id", "position"], name: "idx_on_layer_quiz_question_id_position_67fde4cf67"
    t.index ["layer_quiz_question_id"], name: "index_layer_item_quiz_answers_on_layer_quiz_question_id"
  end

  create_table "layer_quiz_questions", force: :cascade do |t|
    t.bigint "layer_quiz_id", null: false
    t.text "original", default: "", null: false
    t.text "english", default: "", null: false
    t.integer "position", default: 0, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["layer_quiz_id", "position"], name: "index_layer_quiz_questions_on_layer_quiz_id_and_position"
    t.index ["layer_quiz_id"], name: "index_layer_quiz_questions_on_layer_quiz_id"
  end

  create_table "layer_quizzes", force: :cascade do |t|
    t.bigint "chapter_layer_id", null: false
    t.string "title", default: "", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["chapter_layer_id", "title"], name: "index_layer_quizzes_on_chapter_layer_id_and_title"
    t.index ["chapter_layer_id"], name: "index_layer_quizzes_on_chapter_layer_id"
  end
  ...
  add_foreign_key "chapters", "languages"
  ...
  add_foreign_key "layer_quiz_questions", "layer_quizzes"
  add_foreign_key "layer_quizzes", "chapter_layers"
